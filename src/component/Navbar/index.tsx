...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 inset-x-0 z-50 ${isScrolled ? 'bg-white' : 'bg-transparent'} border-b dark:bg-gray-900 shadow-md`}
      ...
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-3">
        ...
        >
          <img
            ...
            alt="Company Logo"
          />
          <span className={`self-center text-2xl font-semibold whitespace-nowrap ${isScrolled ? 'text-black dark:text-white' : 'text-white dark:text-white'}`}>
        ...
        >
          ...
          >
            <Menu.Item key="#part-1">
              <a href="#part-1" onClick={onClose}>Home</a>
            </Menu.Item>
            <Menu.Item key="#part-2">
              <a href="#part-2" onClick={onClose}>Our Offer</a>
            </Menu.Item>
            <Menu.Item key="#part-3">
              <a href="#part-3" onClick={onClose}>Testing Services</a>
            </Menu.Item>
            <Menu.Item key="#part-4">
              <a href="#part-4" onClick={onClose}>About Us</a>
            </Menu.Item>
            <Menu.Item key="#part-5">
              <a href="#part-5" onClick={onClose}>Contact Us</a>
            </Menu.Item>
          </Menu>
        </Drawer>
        ...
        <div className="hidden md:flex w-full md:w-auto">
          <Anchor
            ...
            className={`font-medium flex flex-row space-x-8 rtl:space-x-reverse ${isSmallScreen ? 'text-sm' : ''}`}
            affix={false}
